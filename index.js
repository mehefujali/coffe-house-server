...
async function run() {
  try {
    ...
    const coffeClection = client.db('coffeeDB').collection("coffee")
    
    app.get('/coffee',async (req,res)=> {
         const corsor = coffeClection.find()
    ...
    app.post('/coffee', async(req,res)=>{
      ...
      const result = await coffeClection.insertOne(newCoffee)
      res.send(result)
    })
    ...
    app.delete('/coffee/:id', async(req,res)=>{
      ...
      const result = await coffeClection.deleteOne(qur)
      res.send(result)
    })
